...
en = Locale(
    ...
    support_message="Please report any issues or suggestions to devlab@qq.com\n If you like this App please <a https://buymeacoffee.com/tqye2006>buy me a :coffee:</a>🌝<p> To use other models：<br> OpenAI GPT-4 https://gptecho.streamlit.app <br> Claude https://claudeecho.streamlit.app<br><p>Other Tools：<br>Image Magic https://imagicapp.streamlit.app",
...
zw = Locale(
    ...
    support_message="如遇什么问题或有什么建议，反馈，请电 devlab@qq.com<\n 另外别忘了请我喝杯咖啡:coffee:🌝<p> 使用其它模型：<br><a href=https://gptecho.streamlit.app>OpenAI GPT-4</a><br><a href=https://claudeecho.streamlit.app>Claude</a><p> 其它小工具：<br><a href=https://removebj.streamlit.app/>照片去背景</a>",
