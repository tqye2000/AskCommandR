...
en = Locale(
    ...
    support_message="Please report any issues or suggestions to devlab@qq.com\n If you like this App please buy me a :coffee:🌝<p> To use other models：<br> OpenAI GPT-4 https://gptecho.streamlit.app <br> Claude https://claudeecho.streamlit.app<br><p>Other Tools：<br>Image Magic https://imagicapp.streamlit.app",
