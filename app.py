...
en = Locale(
    ...
    support_message="Please report any issues or suggestions to devlab@qq.com\n If you like this App please buy me a :coffee:🌝<p> To use other models：<br><a href=https://gptecho.streamlit.app>OpenAI GPT-4</a><br><a href=https://claudeecho.streamlit.app/>Claude</a><br><a href=https://askmixtral.streamlit.app>Mixtral 8x7B</a>",
...
zw = Locale(
    ...
    support_message="如遇什么问题或有什么建议，反馈，请电 devlab@qq.com<\n 另外别忘了请我喝杯咖啡:coffee:🌝<p> 使用其它模型：<br><a href=https://gptecho.streamlit.app>OpenAI GPT-4</a><br><a href=https://claudeecho.streamlit.app/>Claude</a>",
