...
zw = Locale(
    ...
    support_message="如遇什么问题或有什么建议，反馈，请电 tqye@yahoo.com\n 使用其它模型：<br>Gemini https://geminiecho.streamlit.app<br>OpenAI GPT-4 https://gptecho.streamlit.app<br>Claude https://claudeecho.streamlit.app<p> 其它小工具：<br><a https://imagicapp.streamlit.app/>照片增强，去背景等</a>",
